---
title: 'FindYourTrip Tech-Stack'
date: 2022-07-03T00:32:14Z
lastmod: '2022-07-03'
tags: ['fyt', 'tech', 'startup', 'system design']
draft: false
summary: 'FindYourTrip Simple, Inexpensive, Scalable Tech-Stack'
layout: PostSimple
...
When selecting FYT’s tech stack, there are a few factors that considered to take decision.
...
and it is farely small learning curve to learn next js if you know react js. Things considered
before choosing it: React, Gatsby

### Material UI

We went with, well-known, Material UI and bought templates for MUI store which costed us 70$ but
...
It has a farely simple and most lenient free tier out of most of the CDN providers with almost all
...
get row level authorization and farely simplified GraphQL endpoints to be used directly with the
frontend. It is easy to setup and scale. You can use Hasura cloud initially to host it and also
